                                                        ...
                                                        <div class="col-10 mt-md-3 pr-5">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-8 col-xl-10">
                                                                    <a
                                                                    class="l-news__small__card-read-more u-line-height-100 hover:u-opacity-8 u-font-weight-bold text-center text-decoration-none u-color-folk-white u-bg-folk-primary py-2 px-5"
                                                                    href="<?php echo esc_url( $rest_post->link ); ?>">
                                                                        Ler mais >
                                                                    </a>
                                                                </div>
